...
//TODO Сохранение камеры в dec и hex
// - Фракцию можно читать как BigInteger и затем его преобразовывать к словам
// - По-умолчанию сохранять в hex (или всё же dec?), потому что в bin слишком много места занимает
// - И тогда наверн придётся отказаться от разделения на слова - но это всё равно было скорее для дебага

//TODO Вывод шагов под курсором
// - in[123]
// - out[456]
